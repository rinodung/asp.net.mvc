...
namespace WebApplication1.Models
{
    ...
    public partial class lst_gc_tbl_HSCB_LyLichCanBo06_ChucVu
    {
        ...
        public Nullable<bool> tbl_DM_TruongVien_MaTruongId_Ten { get; set; }
        public Nullable<int> tbl_BB_Unit_MaTruongId_Name { get; set; }
        public Nullable<int> tbl_DM_KhoaPhongBan_MaKhoaId_Ten { get; set; }
        public Nullable<int> tbl_DM_BoMon_MaBoMonId_Ten { get; set; }
